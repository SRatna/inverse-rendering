...
from datasets import PseudoDataset, BFMDataset
...
full_dataset = BFMDataset(args.syn_data_dir)
...
torch.save(sfs_net.state_dict(), f'{args.out_dir}/mix-sfsnet-bfm.pth')
